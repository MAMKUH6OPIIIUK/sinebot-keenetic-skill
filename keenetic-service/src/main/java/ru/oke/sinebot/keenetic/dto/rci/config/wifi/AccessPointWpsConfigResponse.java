 ...
 * изменения настроек wps на точке доступа
 *
 * @author k.oshoev
 */
@Data
...
public class AccessPointWpsConfigResponse {
    /*
    результат выполнения операции изменения административного статуса функционала WPS на точке доступа
     */
    private ActionEntityStatusArray wps;
}
